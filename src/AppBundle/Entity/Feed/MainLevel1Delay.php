 ...
 * MainLevel1
 *
 * @ORM\Table(name="feed_main_level1_delay")
 * @ORM\Entity(repositoryClass="AppBundle\Repository\Feed\MainLevel1DelayRepository")
 */
class MainLevel1Delay
{
    /**
     * @var string
     *
